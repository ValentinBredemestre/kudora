...
PRODUCT_COMPOSE := env KUDORA_E2E_CONTAINER_PREFIX=kudora-localnet KUDORA_E2E_NETWORK=kudora-localnet-chain KUDORA_E2E_STATE_VOLUME=kudora-localnet-state KUDORA_ETH_CHAIN_ID=0x1d4c2 KUDORA_EVM_CHAIN_ID=120002 KUDORA_EVM_RPC_PORT=8545 KUDORA_EVM_WS_PORT=8546 KUDORA_GRPC_PORT=9090 KUDORA_MAX_DEPOSIT_PERIOD=$(KUDORA_MAX_DEPOSIT_PERIOD) KUDORA_MINIMUM_GAS_PRICES=100000000akud KUDORA_REST_PORT=1317 KUDORA_RPC_PORT=26657 KUDORA_VOTING_PERIOD=$(KUDORA_VOTING_PERIOD) docker compose --project-name kudora-localnet --file deploy/e2e/docker-compose.yml
